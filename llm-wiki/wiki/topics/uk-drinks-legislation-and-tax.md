...
**What this is:** the routing hub for everything regulatory affecting [[kindred-collective]] members. Industry-news ingests about legislation, tax or compliance should link into (and be reachable from) this page. It also feeds the PRD's industry news feed "regulations" filter ([[prd-website-rebuild]]).
