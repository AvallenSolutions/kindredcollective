...
export function ForumCategoryManager({ categories: initialCategories }: { categories: Category[] }) {
  ...
  async function handleSeedDefaults() {
    ...
    try {
      const res = await fetch('/api/admin/forum/categories/seed', { method: 'POST' })
